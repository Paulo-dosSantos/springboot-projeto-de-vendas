...
import com.educandoweb.projeto.services.ServicoDeUsuario;
...
public class UserResource {
	...
	@Autowired
	private ServicoDeUsuario servicos;
	
	@GetMapping
	public ResponseEntity<List<Usuario>> listarTodos(){
		List<Usuario>usuarios= servicos.listarTodos();
		
		return ResponseEntity.ok().body(usuarios);
	}
	@GetMapping(value="/{id}")
	public ResponseEntity<Usuario>encontrarPorId(@PathVariable Long id){
		Usuario usuario= servicos.encontrarPorId(id);
